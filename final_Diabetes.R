#Final Exam CS513 Data mining

#Group
#Amogha Bhemanakolli Gurumallappa        10400051
#Sandesh tumkur jagadish                 10394950
#Sidharth sudhakara arabaghatte          10398292
...
Dataset <- read.csv("G:/SEM-3/DATAMINING-CS513/CS 513/CS 513/data mining _project/data2.csv") 
#Loading csv file
View(Dataset)

Dataset2 <- read.csv("G:/SEM-3/DATAMINING-CS513/CS 513/CS 513/data mining _project/data.csv")
View(Dataset2)
